...
def number_of_books_on_hold():
    return 5
    return 10
print(number_of_books_on_hold()) #10 but actually 5 because the return statement exits the function so the second is never seen
...
print(x) #5 but it's non because the function doesn't actually return anything
...
print(b) # 500
foobar() # 300 and 300
print(b) # 300 but actually 500 because b is a global variable
